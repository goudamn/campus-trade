      ...
      <el-form ref="formRef" :model="data.form" :rules="data.rules" label-width="80px" style="padding-right: 30px; padding-top: 20px">
        ...
        <el-form-item label="支付方式" prop="type" style="margin-top: 30px">
          <el-radio-group v-model="data.form.type">
            <el-radio value="微信支付"><img style="width: 100px; height: 40px" src="@/assets/imgs/wechat.png" alt=""></el-radio>
            <el-radio value="支付宝"><img style="width: 100px; height: 40px" src="@/assets/imgs/alipay.png" alt=""></el-radio>
          </el-radio-group>
        </el-form-item>
      </el-form>
      <template #footer>
